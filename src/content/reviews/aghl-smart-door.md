...
# AGHL Smart Lock: A Surpresa do Mercado
...
<div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 mt-8 mb-8 justify-center w-full">
  <a href="https://produto.mercadolivre.com.br/MLB-4430458805-fechadura-eletroim-al150-agl-_JM?searchVariation=195977155143#polycard_client=search-desktop&searchVariation=195977155143&search_layout=grid&position=1&type=item&tracking_id=8ad2e6c7-cdfe-4ca3-bae0-d31bc318a978" target="_blank" class="btn btn-primary bg-yellow-300 hover:bg-yellow-400 text-black font-bold py-3 px-6 rounded w-full sm:w-auto text-center shadow-lg transition-transform transform hover:scale-105">📦 AGHL Smart Lock no Meli</a>
</div>
