...
<div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 mt-8 mb-8 justify-center w-full">
  <AffiliateButton type="mercadolivre" href="https://www.mercadolivre.com.br/fechadura-digital-sl125-de-sobrepor-resistente-a-maresia-papaiz/p/MLB30904810?pdp_filters=shipping:fulfillment#intervention_type=full&backend_model=search-backend&position=1&search_layout=grid&type=cart_intervention&tracking_id=b08edfe0-bfe9-41a9-80d1-e9fc3103934b" text="📦 Papaiz Smart Lock no Meli" />
</div>
