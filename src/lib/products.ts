...
export const products: Product[] = [
  {
    ...
    amazonUrl: "https://www.amazon.com.br/dp/B09TBDKDVW",
  ...
  },
  {
    ...
    amazonUrl: "https://www.amazon.com.br/dp/B07DJSHN6D",
  ...
  },
  {
    ...
    amazonUrl: "https://www.amazon.com.br/dp/B076HVMT7F",
  ...
  },
  {
    ...
    amazonUrl: "https://www.amazon.com.br/dp/B0BYBBJ69X",
  ...
  },
  {
    ...
    amazonUrl: "https://www.amazon.com.br/dp/B076HWLP7P",
  ...
  },
  {
    id: 9,
    rank: 9,
    name: "Midea Smart Lock One",
    badge: "Robustez e Confiança",
    badgeColor: "primary",
    image: "https://m.media-amazon.com/images/I/51H57j7wBTL._AC_SX679_.jpg",
    specs: ["Biometria 3D", "Teclado Anti-Espião", "Senha", "Cartão"],
    verdict:
      "A Midea chegou pesada no mercado de segurança. Uma opção sólida para quem desejava a Samsung, mas quer garantia nacional e alta resistência estrutural.",
    pros: [
      "Leitor biométrico ultrarrápido (3D)",
      "Estrutura em metal de impacto",
      "Função senha falsa (anti-espião)",
      "Design minimalista e elegante",
    ],
    cons: ["Acesso remoto necessita de bridge", "Ocupa bastante espaço na porta"],
    amazonUrl: "https://www.amazon.com.br/dp/B0BQWG2V9G",
    mlUrl: "https://lista.mercadolivre.com.br/fechadura-midea-smart-lock-one#D[A:fechadura%20midea]",
    reviewUrl: "/review/midea-smart-lock-one",
  },
  {
    id: 10,
    rank: 10,
