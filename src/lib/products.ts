...
export const products: Product[] = [
  ...
  },
  {
    ...
    badge: "Especialista em Vidro",
    badgeColor: "primary",
    image: "https://m.media-amazon.com/images/I/41KxS2p3K9L._AC_SL1000_.jpg",
    ...
    mlUrl: "https://lista.mercadolivre.com.br/intelbras-fr-400#D[A:intelbras%20fr%20400]",
  ...
  },
  {
    ...
    badgeColor: "primary",
    image: "https://m.media-amazon.com/images/I/61U0jV2U9tL._AC_SL1000_.jpg",
    ...
    mlUrl: "https://lista.mercadolivre.com.br/pado-fdv-200#D[A:pado%20fdv%20200]",
    reviewUrl: "/review/pado-fdv-200",
  },
  {
    id: 14,
    rank: 14,
    name: "G-Locks Vitro V90",
    badge: "Melhor para Porta de Correr",
    badgeColor: "primary",
    image: "https://m.media-amazon.com/images/I/51rYF+oU29L._AC_SL1200_.jpg",
    specs: ["Biometria", "Senha", "App TT Lock", "Para Vidro de Correr"],
    verdict:
      "Se sua porta de vidro é de correr, a Vitro V90 é a escolha ideal. Ela possui o fecho em gancho necessário para esse tipo de abertura e gestão completa via app.",
    pros: [
      "Específica para portas de correr",
      "Gestão completa via Bluetooth (TT Lock)",
      "Abertura remota (exige gateway)",
      "Relatório de acessos detalhado",
    ],
    cons: ["Exige Gateway para Wi-Fi", "Instalação requer cuidado no alinhamento"],
    amazonUrl: "https://www.amazon.com.br/dp/B08P97Z2W7",
    mlUrl: "https://lista.mercadolivre.com.br/g-locks-vitro-v90#D[A:g-locks%20vitro%20v90]",
    reviewUrl: "/review/g-locks-vitro-v90",
  },
];
